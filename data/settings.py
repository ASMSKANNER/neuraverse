...
class Settings(Singleton):
    def __init__(self):
        ...
        self.random_pause_start_wallet_min = json_data.get("random_pause_start_wallet", {}).get("min", 1)
        self.random_pause_start_wallet_max = json_data.get("random_pause_start_wallet", {}).get("max", 120)
